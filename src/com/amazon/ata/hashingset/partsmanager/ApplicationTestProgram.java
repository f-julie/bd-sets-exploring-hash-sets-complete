...
// This is our application te program - it has the main() method
// Application programs instantiates objects and manuipuate them through methods
        public static void main(String[] args) {
                System.out.println("-".repeat(50) + "\nDefining flex part...");
                DevicePart flex = new DevicePart("Knowles", "KAS-700-0147","Flex",
                ...
                DevicePart button = new DevicePart("CUI Devices", "CMEJ-04150420P","Button",
                        Arrays.asList(AmazonDevice.ECHO_PLUS));
                System.out.println(button.hashCode()); 

                System.out.print("-".repeat(50) + "\nDefining omnidirectional part...");
                DevicePart omnidirectional = new DevicePart("Knowles", "FG-23329-P142","Omnidirectional",
                        Arrays.asList(AmazonDevice.ECHO_PLUS));
                System.out.println(omnidirectional.hashCode());

                System.out.print("-".repeat(50) + "\nDefining noiseCancelling part...");
                DevicePart noiseCancelling = new DevicePart("Knowles", "FB-EM-30342-000","Noise Cancelling",
                        Arrays.asList(AmazonDevice.ECHO_BUDS));
                System.out.println(noiseCancelling.hashCode()); 

                System.out.print("-".repeat(50) + "\nDefining cuiDevice part...");
                DevicePart cuiDevice = new DevicePart("CUI Devices", "CMEJ-04150420P","CUI Device",
                        Arrays.asList(AmazonDevice.ECHO_PLUS));
                System.out.println(cuiDevice.hashCode()); 

                System.out.print("-".repeat(50) + "\nDefining Wired part...");
                DevicePart wired = new DevicePart("Knowles", "VFG-30747-000","Wired",
                ...
                System.out.println("-".repeat(50) + "\nDefining cord part...");
                DevicePart cord = new DevicePart("CUI Devices", "CMEJ-4622-25-L082","Cord",
                        Arrays.asList(AmazonDevice.ECHO));
                System.out.println(cord.hashCode()); 

                System.out.println("-".repeat(50) + "\nDefining grounded part...");
                DevicePart grounded = new DevicePart("Knowles", "EK-26899-P03","Grounded",
                        Arrays.asList(AmazonDevice.ECHO_FRAMES));
                System.out.println(grounded.hashCode()); 

                System.out.println("-".repeat(50) + "\nDefining puiAudio part...");
                DevicePart puiAudio = new DevicePart("PUI Audio", "AMM-2738B-R","PUI Audio",
                ...
                return;  // not required, but it can be to debug the method by stopping before it terminates
        }
}
